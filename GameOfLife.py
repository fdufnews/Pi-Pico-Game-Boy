...
class GameOfLife():
    ...
    def populate_board(self):
        for i in range(0,self.NUMBER_OF_CELLS):
            ...
            self.board[random.randint(0,self.BOARD_SIZE_Y-1)][random.randint(0,self.BOARD_SIZE_X-1)] = CELL_COLOR
    ...
    def begin(self):
        ...
        while True:
            ...
            for i in range(0,self.BOARD_SIZE_Y):
                for j in range(0,self.BOARD_SIZE_X):
                    if self.board[i][j]!=0:
                        self._pgb.fill_rect(j*self.CELL_SIZE,i*self.CELL_SIZE,self.CELL_SIZE,self.CELL_SIZE,self.board[i][j])
            self._pgb.show()
            ...
            for i in range(0,self.BOARD_SIZE_Y):
                for j in range(0,self.BOARD_SIZE_X):
                    pop += 1 if self.board[i][j]!=BLACK else 0
                    number_neighbors = 0
